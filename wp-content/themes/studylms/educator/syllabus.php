												...
												<div class="lessin-wrapper">
													<div class="lesson-icon">
														...
														<?php $has_quiz = (boolean) get_post_meta( $lesson_id, '_edr_quiz', true );
															...
															$les_title = $post->post_title;
														if ($has_quiz) { ?>
															<i class="mn-icon-274"></i>
														<?php } else if(strpos($les_title, 'Video')!== false){ ?>
															<i class="mn-icon-492"></i>
														<?php
														} else { ?>
													...
													<div class="lesson-header">
														<?php if ($access) { ?>
															<a class="lesson-title openPopup" data-href="<?php the_permalink(); ?>" data-title="<?php the_title(); ?>" href="javascript:void(0);">
														<?php } ?>
															<?php the_title(); ?>
														<?php if ($access) { ?>
															</a>
