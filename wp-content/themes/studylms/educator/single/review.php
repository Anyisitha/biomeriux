		...
		<div class="comment-text media-body">
			<div class="clearfix">
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p class="meta pull-left"><span class="apus-author clear" itemprop="author"><?php comment_author(); ?></span> <em><?php esc_html_e( 'Su comentario está pendiente de aprobación', 'studylms' ); ?></em></p>
				<?php else : ?>
