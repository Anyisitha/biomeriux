...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="row">
            ...
            <div class="entry-head" style="display:none">
                <div class="info-left">
            ...
            <div class="info-meta edr-course clearfix" style="display:none">
            ...
            <div class="entry-thumb <?php echo  (!has_post_thumbnail() ? 'no-thumb' : ''); ?>" style="display:none">
                <?php
 ...
                    <h3 class="title-tab"><?php echo esc_html__('Descripción del curso', 'studylms') ?></h3>
                    <?php the_content(); ?>
                </div><!-- /entry-content -->
                ...
                <div class="widget widget-special-features size-container">
                    <?php
                        $buy_html = edr_get_buy_widget( array( 'object_id' => $course_id, 'object_type' => EDR_PT_COURSE, 'label' => esc_html__( 'Adquiere este curso', 'studylms' ) ) ); ?>
                    ...
                    <div class="widget-content">
                        <?php if (!empty($buy_html)) { ?>
                            <div class="widget-price">
                                <div class="price-label"><?php esc_html_e( 'Precio:', 'studylms' ); ?></div>
                                <?php echo trim($buy_html); ?>
                            </div>
                        <?php } ?>
