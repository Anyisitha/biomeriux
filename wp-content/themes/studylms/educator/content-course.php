...
$cour_syllab = $edr_courses->get_syllabus( $course_id );
$cour_modules = intval(count($cour_syllab))
//print_r();
?>
<article id="course-<?php echo intval( $course_id ); ?>" class="edr-course edr-course-grid">
	...
	<div class="meta-data clearfix">
		<div class="header-meta clearfix">
			...
			<div class="courseModuleCount">
				<img src="/wp-content/uploads/2020/09/article.svg" alt="modulos" /> <?php echo trim($cour_modules); ?> MÓDULOS
			</div>
		</div>

	</div>

	<a href="<?php the_permalink(); ?>" class="accederBtn">acceder</a>
