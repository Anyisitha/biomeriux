...
<div class="product-block" data-product-id="<?php echo esc_attr($product->get_id()); ?>">
    <figure class="image">
        ...
        <div class="button-action clearfix">                
            ...
            <?php } ?>
            <?php if (studylms_get_config('show_quickview', true)) { ?>
                <div class="quick-view">
                    <a href="<?php the_permalink(); ?>" class="quickview" data-productslug="<?php echo trim($post->post_name); ?>">
                       <i class="fa fa-eye"> </i><span><?php esc_html_e( 'Quick view', 'studylms' ); ?></span>
                    </a>
                </div>
            <?php } ?> 
        </div>
