...
?>
<section id="main-container" class="main-content  <?php echo apply_filters('studylms_blog_content_class', 'container');?> inner 4">
	<div class="row">
		...
		<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php
				$layout = studylms_get_blogs_layout_type();
