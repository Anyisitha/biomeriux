...
class Studylms_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'studylms'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'studylms' ), )
        );
...
register_widget( 'Studylms_Search' );