...
class Studylms_Widget_Contact_Info extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_contact_info',
            esc_html__('Apus Contact Info Widget', 'studylms'),
            array( 'description' => esc_html__( 'Show Contact Info', 'studylms' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <div class="address-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'address_icon' )); ?>"><?php esc_html_e( 'Icon:', 'studylms' ); ?></label>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'address_content' )); ?>"><strong><?php esc_html_e('Address Content:', 'studylms');?></strong></label>
        ...
        <div class="phone-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'phone_icon' )); ?>"><?php esc_html_e( 'Icon:', 'studylms' ); ?></label>
            <div class="screenshot">
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'phone_content' )); ?>"><strong><?php esc_html_e('Phone Content:', 'studylms');?></strong></label>
        ...
        <div class="email-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'email_icon' )); ?>"><?php esc_html_e( 'Icon:', 'studylms' ); ?></label>
            <div class="screenshot">
                <?php if ( $instance['email_icon'] ) { ?>
                    <img src="<?php echo esc_url($instance['email_icon']); ?>" style="max-width:100%" alt=""/>
                <?php } ?>
            </div>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'email_content' )); ?>"><strong><?php esc_html_e('Email Content:', 'studylms');?></strong></label>
...
register_widget( 'Studylms_Widget_Contact_Info' );