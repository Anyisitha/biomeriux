...
<div class="widget-testimonials <?php echo esc_attr($el_class. ' '. $layout_type); ?> <?php echo esc_attr(($layout_type =='style3')?'under-line widget':''); ?>">
	...
	<?php if ( $loop->have_posts() ): ?>
        <div class="owl-carousel <?php echo esc_attr(($layout_type =='style3')?'owl-carousel-top':''); ?>" data-items="<?php echo esc_attr($columns); ?>" data-carousel="owl" data-pagination="false" data-nav="true" data-smallmedium="1" data-extrasmall="1">
                        ...
                        <div class="clearfix info-bottom">
                            ...
                            <div class="testimonial-meta">
                                <div class="info">
                                    ...
                                    <?php } ?>
                                    <span class="job"> <span class="space">-</span> <?php echo trim($job); ?></span>   
                                </div>
                            </div>
                        </div>
                    </div> 
