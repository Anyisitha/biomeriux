 ...
 */
	...
	define('DB_NAME',          'eleark8pri_biomeriux');
	define('DB_USER',          'eleark8pri_biomeriux');
	define('DB_PASSWORD',      'Biomeriuz2022');
	define('DB_HOST',          '135.148.28.53');
